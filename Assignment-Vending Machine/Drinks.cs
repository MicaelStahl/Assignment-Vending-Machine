...
{
    /// <summary>
    /// The Drinks section of Products - inherits everything from the IProducts interface
    /// </summary>
    class Drinks : IProducts
    {
        ...
        public Drinks(string name, int size, int cost, string description, string use, string taste)
        {
            this.name = name;
            this.size = size;
            this.cost = cost;
