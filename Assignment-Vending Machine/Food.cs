...
{
    /// <summary>
    /// The Food section of Products - inherits everything from the IProducts interface
    /// </summary>
    class Food : IProducts
    {
        ...
        public Food(string name, int size, int cost, string description, string use, string taste)
        {
            this.name = name;
            this.size = size;
            this.cost = cost;
